...
public class MeshSortingOrderEditor : Editor {
    ...
    private void OnEnable() {
        string[] sortingLayerNames = MeshSortingOrderEditor.GetSortingLayerNames();
        ...
        this.sortingLayerIds = MeshSortingOrderEditor.GetSortingLayerUniqueIDs();
    }
